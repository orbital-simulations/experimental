...
use crate::{
    buffers::{WriteableBuffer, IndexBuffer, DescriptiveBuffer},
    context::{Context, RenderingContext},
    raw::Gpu, pipeline::{Pipeline, CreatePipeline}, render_pass::RenderTarget,
};
...
impl FilledCircleRenderer {
    pub fn new(context: &Context, rendering_context: &RenderingContext, render_target: &RenderTarget) -> Self {
        ...
        let vertex_buffer = WriteableBuffer::new(context, "circle vertex buffer", &CIRCLE_VERTICES, wgpu::BufferUsages::VERTEX);
