...
impl FilledCircleRenderer {
    pub fn new(
        ...
        let shader_description = ShaderDescription::ShaderStatic(ShaderStatic {
            unique_shader_name: "filled_circle".to_string(),
            static_shader_module_descriptor: include_wgsl!("../shaders/filled_circle.wgsl"),
        });
        let shader = {
        ...
        let pipeline_description = PipelineDescription {
            label: "filled circle renderer pipeline".to_string(),
            layout: Some(PipelineLayoutDescription {
                label: "filled circle renderer layout".to_string(),
            ...
            vertex: VertexStateDescription {
                buffers: vec![
                    ...
                    VertexBufferLayoutDescriptor {
                        ...
                        attributes: CIRCLE_VERTEX_ATTRIBUTES.to_vec(),
                    },
                ],
                module: shader.clone(),
            },
